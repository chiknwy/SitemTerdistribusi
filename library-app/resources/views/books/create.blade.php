...
<body class="bg-gray-900 text-blue-400">
        ...
        <nav class="container mx-auto flex items-center justify-between opacity-100">
            ...
            <div class="sm:hidden relative">
                <button id="menu-toggle"
                    class="text-blue-400 hover:text-white transition-transform transform">
    ...
    <div class="container mx-auto flex items-center justify-center">
        <h1 class="text-4xl font-bold text-blue-400">Add a New Book</h1>
    </div>

    
    
    <div class="container mx-auto flex items-center justify-center ">
        <form method="post" action="{{ url('/books') }}" class="max-w-lg bg-gray-900 p-6 rounded-md" enctype="multipart/form-data">
            @csrf
            <div class="mb-4">
           ...
           <input type="hidden" name="user_id" value="{{ auth()->user()->id }}">
            ...
            <button type="submit"
                class="bg-blue-400 text-gray-900 px-4 py-2 rounded-md hover:bg-blue-500 transition duration-300">Save</button>
        </form>
    </div>
