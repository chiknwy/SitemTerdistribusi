...
<body class="bg-gray-900 text-blue-400">
    ...
    <!-- <table class="w-2/3 border-collapse border my-4 text-blue-400 py-5">

        <thead>
            <tr class="bg-gray-900">
                <th class="border border-transparent black py-2 px-3">Title</th>
                <th class="border border-transparent black py-2 px-3">Author</th>
                <th class="border border-transparent black py-2 px-3">ISBN</th>
                <th class="border border-transparent black py-2 px-3">Details</th>
            </tr>
        </thead>
        <tbody>
            <tr v-for="(book, index) in books" class="bg-gray-900">
                <td class="border border-transparent black py-3 px-4 text-lg">Harry Potter</td>
                <td class="border border-transparent black py-3 px-4 text-lg">J.K Rowling</td>
                <td class="border border-transparent black py-3 px-4 text-lg">53141123</td>
                <td class="border border-transparent black py-3 px-4 text-lg">Published 1998</td>
